...
export default {
  ...
  setup (props) {
    ...
    const editTodo = (todo, value) => store.dispatch('todomvc/editTodo', { todo, value })
    const toggleTodo = (todo) => store.dispatch('todomvc/toggleTodo', todo)
    const removeTodo = (todo) => store.dispatch('todomvc/removeTodo', todo)
